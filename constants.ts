...
export const COURSE_MODULES: CourseModuleData[] = [
  ...
  },
  {
    ...
    description: 'A deep dive into TGC. Learn how it compensates for attenuation, ensures uniform image brightness, and improves diagnostic accuracy through an interactive simulation.',
    features: [
